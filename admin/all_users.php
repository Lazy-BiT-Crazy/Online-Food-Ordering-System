                            ...
                            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                                ...
                                <div class="navbar-collapse">
                                    ...
                                    <ul class="navbar-nav my-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/Admin1.png" alt="user" class="profile-pic" /></a>
